...
use crate::v1::core::{Protocol, protocol::ProtocolError};
...
use crate::v1::protocols::openai::{OpenAIRequest, OpenAIResponse};
#[cfg(feature = "streaming")]
use crate::v1::protocols::openai::OpenAIStreamResponse;
...
pub fn zhipu(base_url: &str, api_key: &str) -> Result<crate::v1::core::provider::ProtocolProvider<ZhipuProtocol>, LlmConnectorError> {
    let protocol = ZhipuProtocol::new();
    crate::v1::core::provider::ProtocolProvider::new(protocol, base_url, api_key)
}

/// Convenience function to create a Zhipu provider with default endpoint
pub fn zhipu_default(api_key: &str) -> Result<crate::v1::core::provider::ProtocolProvider<ZhipuProtocol>, LlmConnectorError> {
...
pub fn zhipu_with_timeout(api_key: &str, timeout_ms: u64) -> Result<crate::v1::core::provider::ProtocolProvider<ZhipuProtocol>, LlmConnectorError> {
    let protocol = ZhipuProtocol::new();
    ...
    Ok(crate::v1::core::provider::ProtocolProvider::from_parts(protocol, "https://open.bigmodel.cn/api/paas/v4", transport))
}